...
![Example of failure of closure under scalar multiplication](../../../../images/vectors-subspace-example-quadrants-hand-drawn-white-grid.png){#fig-vectors-subspace-example-quadrants width=50%}
